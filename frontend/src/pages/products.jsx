...
const productCategories = [
  {
    ...
    products: [
      { 
        ...
        description: "Advanced programmable logic controller with 256 I/O points, Ethernet connectivity, and integrated motion control capabilities.", 
        price: "$2,499",
        image: "🎛️",
        specs: ["256 I/O Points", "EtherNet/IP", "Motion Control", "IEC 61131-3"],
        stock: 15,
        rating: 4.8,
        reviews: 124
      },
      { 
        ...
        description: "Industrial-grade touch screen interface with high-resolution display, multi-protocol support, and rugged design for harsh environments.", 
        price: "$1,299",
        image: "📱",
      ...
      { 
        ...
        description: "High-precision servo drive with advanced motion algorithms, real-time feedback, and compact design for tight spaces.", 
        price: "$899",
        image: "⚙️",
      ...
      { 
        ...
        description: "Variable frequency drive with built-in PLC, energy optimization, and predictive maintenance features.", 
        price: "$749",
        image: "🔄",
      ...
      { 
        ...
        description: "Versatile 6-axis robot arm with 10kg payload capacity, ideal for pick-and-place, welding, and assembly applications.", 
        price: "$15,999",
        image: "🤖",
      ...
      { 
        ...
        description: "Specialized drive for conveyor applications with synchronized multi-motor control and energy regeneration.", 
        price: "$1,199",
        image: "🔧",
  ...
  },
  {
    ...
    products: [
      { 
        ...
        description: "High-accuracy RTD temperature sensor with 4-20mA output, suitable for extreme environments up to 500°C.", 
        price: "$129",
        image: "🌡️",
        specs: ["-50 to 500°C", "±0.1°C Accuracy", "4-20mA Output", "SS316 Housing"],
        stock: 156,
        rating: 4.7,
        reviews: 312
      },
      { 
        ...
        description: "3-axis vibration sensor with built-in FFT analysis, wireless connectivity, and predictive maintenance algorithms.", 
        price: "$249",
        image: "📳",
      ...
      { 
        ...
        description: "Digital pressure transmitter with HART protocol, 0.04% accuracy, and built-in diagnostics.", 
        price: "$349",
        image: "🔵",
      ...
      { 
        ...
        description: "Non-invasive clamp-on flow meter for liquids, easy installation without pipe cutting.", 
        price: "$599",
        image: "💧",
      ...
      { 
        ...
        description: "Complete kit with inductive, capacitive, and photoelectric sensors for various detection needs.", 
        price: "$189",
        image: "🎯",
      ...
      { 
        ...
        description: "Central hub for connecting multiple sensors, with cloud connectivity, edge computing, and protocol conversion.", 
        price: "$449",
        image: "🌐",
  ...
  },
  {
    ...
    products: [
      { 
        ...
        description: "Molded case circuit breaker with adjustable thermal-magnetic trip, high breaking capacity.", 
        price: "$189",
        image: "🔌",
      ...
      { 
        ...
        description: "Medium voltage switchgear assembly with vacuum circuit breakers, metering, and protection relays.", 
        price: "$14,999",
        image: "🎚️",
      ...
      { 
        ...
        description: "Double-conversion online UPS with pure sine wave output, hot-swappable batteries, and remote monitoring.", 
        price: "$2,899",
        image: "🔋",
        specs: ["10kVA/9kW", "Online Double-Conversion", "0ms Transfer", "SNMP Card"],
        stock: 19,
        rating: 4.7,
        reviews: 134
      },
      { 
        ...
        description: "Cast resin dry-type transformer for indoor installation, low noise, and maintenance-free operation.", 
        price: "$8,499",
        image: "⚡",
      ...
      { 
        ...
        description: "Automatic power factor correction controller with 12 stages, harmonic measurement, and energy monitoring.", 
        price: "$549",
        image: "📊",
      ...
      { 
        ...
        description: "Type 1+2 combined surge protector for complete facility protection against lightning and switching surges.", 
        price: "$299",
        image: "🛡️",
  ...
  },
  {
    ...
    products: [
      { 
        ...
        description: "Full-featured SCADA system with unlimited tags, redundancy, historian, and mobile access.", 
        price: "$9,999",
        image: "📊",
      ...
      { 
        ...
        description: "Complete manufacturing execution system for production tracking, quality management, and OEE monitoring.", 
        price: "$14,999",
        image: "🏭",
        specs: ["Production Tracking", "Quality Module", "OEE Dashboard", "ERP Integration"],
        stock: 999,
        rating: 4.9,
        reviews: 178
      },
      { 
        ...
        description: "Comprehensive asset lifecycle management with preventive maintenance scheduling and spare parts inventory.", 
        price: "$4,999",
        image: "📋",
      ...
      { 
        ...
        description: "Machine learning platform for predictive maintenance, anomaly detection, and failure prediction.", 
        price: "$7,999",
        image: "🤖",
        specs: ["ML Algorithms", "Anomaly Detection", "RUL Prediction", "API Access"],
        stock: 999,
        rating: 4.7,
        reviews: 112
      },
      { 
        ...
        description: "Monitor and optimize energy consumption across facilities with real-time analytics and reporting.", 
        price: "$5,999",
        image: "🔋",
        specs: ["Real-time Monitoring", "Cost Analysis", "ISO 50001", "Dashboards"],
        stock: 999,
        rating: 4.5,
        reviews: 89
      },
      { 
        ...
        description: "Universal PLC programming software supporting multiple vendors with simulation and version control.", 
        price: "$1,999",
        image: "💻",
        ...
        <div className="p-6">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              {/* Specifications */}
              <div className="mb-6">
                <h4 className="text-sm font-semibold text-gray-300 mb-3">Key Specifications</h4>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-gray-400 text-sm">
                  Total: <span className="text-white font-bold">${(parseFloat(product.price.replace(/[$,]/g, "")) * quantity).toLocaleString()}</span>
                </span>
              </div>
          ...
          <div className="mt-8 border-t border-gray-800 pt-6">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-800/50 rounded-xl p-4">
                ...
                <h4 className="font-semibold text-white mb-1">2-Year Warranty</h4>
                <p className="text-gray-400 text-sm">Full manufacturer warranty</p>
              </div>
            </div>
          </div>
        </div>
...
function CartSidebar({ isOpen, onClose, cartItems, updateQuantity, removeFromCart, getCartTotal, clearCart }) {
...
export default function Products() {
  ...
  const { cartItems, isCartOpen, setIsCartOpen, addToCart, removeFromCart, updateQuantity, clearCart, getCartTotal, getCartCount } = useCart();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
            <div className="text-center sm:text-left">
              <h2 className="text-2xl font-bold text-white mb-1">{activeCategory.name}</h2>
                ...
                <div className="p-5 flex flex-col h-full">
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    {product.specs.slice(0, 2).map((spec, index) => (
                      <span key={index} className="px-2 py-0.5 bg-gray-800 text-gray-400 text-xs rounded">
                        {spec}
                      </span>
                    ))}
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <span className="text-xl font-bold text-green-500 whitespace-nowrap">{product.price}</span>
                    <button 
